# 🏠 AI Home CoPilot - Einrichtungsanleitung

> **Version:** v0.9.3 | **Letzte Aktualisierung:** 15.02.2026

Diese Anleitung führt dich Schritt für Schritt durch die Installation und Konfiguration des AI Home CoPilot für Home Assistant.
...
## 🚀 Schritt 2: AI Home CoPilot installieren

### Option A: Über HACS (empfohlen)

1. **Home Assistant → HACS**
2. **Integrations** → 🔍 nach "AI Home CoPilot" suchen
...
git clone https://github.com/GreenhillEfka/ai-home-copilot-ha.git ai_home_copilot
```
...
3. Nach "AI Home CoPilot" suchen
4. Klicken auf **AI Home CoPilot**
...
3. **Karte hinzufügen** → **AI Home CoPilot** auswählen
...
1. **AI Home CoPilot Integration** → **Konfigurieren**
...
Dein AI Home CoPilot ist jetzt eingerichtet. 
...
- **GitHub Issues:** https://github.com/GreenhillEfka/ai-home-copilot-ha/issues
