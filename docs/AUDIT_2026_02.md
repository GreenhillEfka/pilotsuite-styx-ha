# PilotSuite — Code-Audit Februar 2026

> Automatisierte Fehleranalyse beider Repositories.

---

## Repo 1: pilotsuite-styx-ha (Integration v0.3.2)
...
## Repo 2: pilotsuite-styx-core (Core v0.2.7)
...
|------|----------|------|--------|---------|--------|
| pilotsuite-styx-ha | 0 | 2 | 2 | 3 | **7** |
| pilotsuite-styx-core | 8 | 1 | 3 | 2 | **14** |
| **Gesamt** | **8** | **3** | **5** | **5** | **21** |
