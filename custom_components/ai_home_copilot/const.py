...
# Legacy YAML dashboards (Lovelace) wiring / generation.
# Default: enabled (zero-config expects dashboards to exist on first run).
CONF_LEGACY_YAML_DASHBOARDS = "legacy_yaml_dashboards"
...
DEFAULT_EVENTS_FORWARDER_ENABLED = True
...
# Mood System (v3.0)
CONF_MOOD_ENABLED = "mood_enabled"
CONF_MOOD_EMA_ALPHA = "mood_ema_alpha"
CONF_MOOD_SOFTMAX_TEMPERATURE = "mood_softmax_temperature"
CONF_MOOD_DWELL_TIME_SECONDS = "mood_dwell_time_seconds"
CONF_MOOD_HISTORY_RETENTION_DAYS = "mood_history_retention_days"

DEFAULT_MOOD_ENABLED = True
DEFAULT_MOOD_EMA_ALPHA = 0.3
DEFAULT_MOOD_SOFTMAX_TEMPERATURE = 1.0
DEFAULT_MOOD_DWELL_TIME_SECONDS = 600
DEFAULT_MOOD_HISTORY_RETENTION_DAYS = 30
...
DEFAULTS_MAP: dict[str, object] = {
    ...
    # Dashboards / Lovelace wiring
    CONF_LEGACY_YAML_DASHBOARDS: DEFAULT_LEGACY_YAML_DASHBOARDS,
    # Watchdog
    ...
    # Mood System
    CONF_MOOD_ENABLED: DEFAULT_MOOD_ENABLED,
    CONF_MOOD_EMA_ALPHA: DEFAULT_MOOD_EMA_ALPHA,
    CONF_MOOD_SOFTMAX_TEMPERATURE: DEFAULT_MOOD_SOFTMAX_TEMPERATURE,
    CONF_MOOD_DWELL_TIME_SECONDS: DEFAULT_MOOD_DWELL_TIME_SECONDS,
    CONF_MOOD_HISTORY_RETENTION_DAYS: DEFAULT_MOOD_HISTORY_RETENTION_DAYS,
    # Mood Dashboard
