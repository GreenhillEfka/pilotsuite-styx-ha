...
from .core.modules.energy_module import EnergyModule
...
def _get_runtime(hass: HomeAssistant) -> CopilotRuntime:
    ...
    if "energy_module" not in runtime.registry.names():
        runtime.registry.register("energy_module", EnergyModule)
    return runtime
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    await runtime.async_setup_entry(entry, modules=["legacy", "events_forwarder", "dev_surface", "energy_module"])
    return True


async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    runtime = _get_runtime(hass)
    return await runtime.async_unload_entry(entry, modules=["legacy", "events_forwarder", "dev_surface", "energy_module"])
